...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT_65_ansi(
        ...
        _______, KC_CALC, KC_APP,  G_AMD,   G_AL,    G_ECL,   KC_INS,  KC_HOME, KC_UP,   KC_END,  KC_PGUP, KC_PSCR, KC_SCRL, KC_PAUS, DM_REC2,
    ...
    [_SY] = LAYOUT_65_ansi(
        ...
        XXXXXXX, M_11SPC, M_11BS,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
