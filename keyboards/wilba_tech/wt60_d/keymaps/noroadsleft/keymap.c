...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT_60_iso_tsangan_split_rshift(
        ...
        _______, KC_CALC, KC_APP,  _______, _______, MS_WHLU, KC_INS,  KC_HOME, KC_UP,   KC_END,  KC_PGUP, KC_PSCR, KC_SCRL,
        _______, M_SALL,  _______, _______, _______, MS_WHLD, KC_DEL,  KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______, KC_PAUS, KC_PENT,
